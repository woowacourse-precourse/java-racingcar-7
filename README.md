...
- <a href="#-프로젝트-소개" style="color:white;">📌 프로젝트 소개</a>
- <a href="#-프로젝트-구조" style="color: white;">📂 프로젝트 구조</a>
- <a href="#-기능" style="color: white;">🚀 기능</a>
- <a href="#-입출력-예시" style="color: white;">🖥️ 입출력 예시</a>
    - <a href="#입력" style="color: white;">입력</a>
    - <a href="#출력" style="color: white;">출력</a>
    - <a href="#실행-결과-예시" style="color: white;">실행 결과 예시</a>
- <a href="#-예외-사항" style="color: white;">🚨 예외 사항</a>
    - <a href="#자동차-이름-입력-오류" style="color: white;">자동차 이름 입력 오류</a>
    - <a href="#시도-횟수-입력-오류" style="color: white;">시도 횟수 입력 오류</a>
- <a href="#-사전-요구-사항" style="color: white;">⭐ 사전 요구 사항</a>
    - <a href="#과제-진행-요구-사항" style="color: white;">과제 진행 요구 사항</a>
    - <a href="#프로그래밍-요구-사항-1" style="color: white;">프로그래밍 요구 사항 1</a>
    - <a href="#프로그래밍-요구-사항-2" style="color: white;">프로그래밍 요구 사항 2</a>
- <a href="#-라이브러리-사용-안내" style="color: white;">📦 라이브러리 사용 안내</a>
- <a href="#-회고" style="color: white;">🤔 회고</a>
