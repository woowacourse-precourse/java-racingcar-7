### 최종 목표: 다른 사람들에게 코드 의미 전달이 되게 과제 만들기

---

## 과제 진행 중간에 메타인지가 됐던 순간들
...
<details>
<summary> ❗개발에 빠져 잊고 있던 커밋 메시지의 전달력</summary>
...
└── racingcar
        ...
        │   │   └── GameException.java
        │   ├── message
        │   │   ├── CarNameExceptionMessage.java
        │   │   ├── GameExceptionMessages.java
        │   │   ├── InputExceptionMessages.java
        │   │   ├── PlayerCountExceptionMessage.java
        │   │   └── PlayerExceptionMessages.java
        │   └── player
        │       └── PlayerException.java
        ├── repository
        │   ├── MemoryPlayerRepository.java
...
## Controller-Service-Repository 기능 목록

## Controller

<h3> 1. 게임 컨트롤러(GameController) 유스케이스 </h3>
...
<h3> 1. 게임 서비스(GameService) 유스케이스 </h3>
...
<h3> 2. 플레이어 서비스(PlayerService) 유스케이스  </h3>
...
<h3> 1. 플레이어 레파지토리(PlayerRepository) 유스케이스 </h3>
