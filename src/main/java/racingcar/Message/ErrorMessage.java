...
public class ErrorMessage {
    ...
    public static final String ERROR_MESSAGE_BLANK = "자동차 이름이 비어 있습니다.";
    public static final String ERROR_MESSAGE_LENGTH = "자동차 이름은 5글자 이하로 해야 합니다.";
    public static final String ERROR_MESSAGE_INVALID_MOVE_COUNT = "시도 횟수는 1 이상의 숫자여야 합니다.";
