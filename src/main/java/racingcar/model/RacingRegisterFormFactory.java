...
public class RacingRegisterFormFactory {
    ...
    public static RacingRegisterForm createFrom(String inputCarNames, String inputRaceRoundCount) {
    ...
    private static List<String> convertCarNames(String input) {
        return Arrays.stream(input.split(SEPARATOR))
                .map(String::trim)
                .toList();
    }

    private static int convertRaceRoundCount(String input) {
        try {
