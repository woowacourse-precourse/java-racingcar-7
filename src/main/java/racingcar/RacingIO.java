...
public class RacingIO {
    ...
    public static void promptTurnResult(LinkedList<LinkedHashMap<String, Integer>> turnResults) {
        System.out.println();
        System.out.println(TURN_RESULT_PROMPT);

        for (LinkedHashMap<String, Integer> turnResult : turnResults) {
            formatTurnResult(turnResult);
            System.out.println();
        }
    }

    private static void formatTurnResult(LinkedHashMap<String, Integer> turnResult) {
