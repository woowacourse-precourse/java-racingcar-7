...
public class WinnerCaculator {
    ...
    public List<String> WinnerResult(List<String> carName, List<Integer> carRandomNumber, int randomNumber, int repeat) {
        ...
        carDistance.CarDistanceCaculator(carName, totalWinners);

        if(repeat + 1 == randomNumber) {
            winnerOutput.FinallyWinner(totalWinners);
        }
        return winnerName;
    }
}
