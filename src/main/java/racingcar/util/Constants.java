...
public class Constants {
    ...
    // 예외 메시지
    public static final String EMPTY_INPUT_VALUE = "입력값이 공백일 수 없습니다.";
    public static final String EMPTY_CAR_NAMES_ERROR = "자동차 이름 입력이 비어있습니다.";
    public static final String EMPTY_LIST_ERROR = "자동차 리스트가 비어있습니다.";
    public static final String BLANK_NAME_ERROR = "자동차 이름이 공백일 수 없습니다.";
