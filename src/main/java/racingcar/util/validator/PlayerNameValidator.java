...
import static racingcar.util.constant.Constants.MAX_NAME_LENGTH;
import static racingcar.util.message.ErrorMessages.ERROR_EMPTY_NAME;
import static racingcar.util.message.ErrorMessages.ERROR_LENGTH_LIMIT_NAME;
