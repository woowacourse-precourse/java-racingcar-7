...
public enum ExceptionEnum {
    ...
    // 자동차 이름 관련 예외 메시지
    INVALID_MIN_CAR_NAME_LENGTH("자동차 이름은 최소 1글자 이상이어야 합니다."),
    INVALID_MAX_CAR_NAME_LENGTH("자동차 이름은 5글자를 초과할 수 없습니다."),
    EMPTY_CAR_NAME("자동차 이름은 빈 입력일 수 없습니다."),
    DUPLICATE_CAR_NAME("자동차 이름은 중복될 수 없습니다. 중복된 자동차 이름 : "),
    INVALID_CAR_NAME_FORMAT("자동차 이름으로 특수문자, 숫자 또는 한글은 사용할 수 없습니다."),
    NULL_CAR_NAME("자동차 이름은 null일 수 없습니다."),
