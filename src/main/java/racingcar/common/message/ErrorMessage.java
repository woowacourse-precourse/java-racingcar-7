...
public class ErrorMessage {
    ...
    public static String DISTANCE_SHOULD_NOT_BE_MINUS = format(ERROR_PREFIX, "거리는 0보다 크거나 같아야 합니다.");
    ...
    public static String LOWER_THAN_ONE = format(ERROR_PREFIX, "Lap 횟수는 0 보다 커야 합니다.");
    public static String UN_NECESSARY_CHAR_INCLUDED = format(ERROR_PREFIX, "숫자 외에 다른 문자는 입력하시면 안됩니다.");
