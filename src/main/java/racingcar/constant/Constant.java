...
public class Constant {
    ...
    public static final String CAR_NAME_INPUT_STRING = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
    public static final String TRY_COUNT_INPUT_STRING = "시도할 횟수는 몇 회인가요?";
    public static final String RACING_PROGRESS_STRING = "실행 결과";
    ...
    public static final String COUNT_ONLY_INTEGER_NUMBER_STRING = "시도할 횟수는 2147483647 값을 초과해서는 안됩니다.";
