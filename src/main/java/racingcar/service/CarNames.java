...
/**
 * 자동차 이름을 처리하고 자동차 객체 리스트를 관리하는 서비스 클래스입니다. 사용자로부터 입력받은 자동차 이름 문자열을 분리하여 각 이름으로 자동차 객체를 생성합니다.
 */
public class CarNames {
    ...
    /**
     * 생성자. 입력된 자동차 이름 문자열을 쉼표(,)로 분리하여 각 이름으로 자동차 객체를 생성하고 리스트에 추가합니다.
     *
