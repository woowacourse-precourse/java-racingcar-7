...
public class Application {
    public static void main(String[] args) {
        ...
        try {
            ...
            List<String> totalRoundResultList = randomPicker.runTotalRandom(carNames, totalRounds);
            System.out.println(messagePrinter.getTotalResultMessage(totalRoundResultList));

            //우승자 목록 도출
            TreeMap<String, Integer> forwardCounter = mapBuilder.getForwardCount();
