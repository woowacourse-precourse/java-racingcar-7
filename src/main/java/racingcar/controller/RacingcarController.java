...
public class RacingcarController {
    ...
    public void getUserInput() throws IllegalArgumentException {
        ...
        handleExceptionNamesOfCars(namesOfCars);
        ...
        handleExceptionNumberOfRaces(numberOfRaces);
        racingService.race(numberOfRaces);
    }

    public void handleExceptionNamesOfCars(String namesOfCars) {
    ...
    public void handleExceptionNumberOfRaces(int numberOfRaces) {
