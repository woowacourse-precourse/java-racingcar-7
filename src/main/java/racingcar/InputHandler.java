...
public class InputHandler {
    ...
    private static final String ERROR_EMPTY_INPUT = "빈 값을 입력할 수 없습니다.";
    private static final String ERROR_SPECIAL_CHARACTERS = "입력에 특수 문자가 포함되어 있습니다. 문자, 숫자, 하이픈(-) 그리고 구분자 쉼표(,)만 허용됩니다.";
    private static final String ERROR_NAME_LENGTH = "자동차 이름은 5자 이하여야 합니다: ";
    private static final String ERROR_NON_NUMERIC = "시도 횟수는 숫자여야 합니다.";
    private static final String ERROR_NEGATIVE_ATTEMPTS = "시도 횟수는 0 이상이어야 합니다.";
    ...
    private static void validateCarNames(String carNamesInput) {
        ...
        for (String name : carNames) {
            if (name.trim().length() > 5) {
                throw new IllegalArgumentException(ERROR_NAME_LENGTH + name);
            }
        }
    }
