...
class InputViewTest {
    ...
    void 빈_문자열_입력_예외() {
        ...
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, inputView::getCarNames);
    ...
    void 숫자_아닌_시도횟수_입력_예외() {
        ...
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, inputView::getNumberOfRounds);
