...
public class RaceTest {
    ...
    @Test
    void 자동차_이름이_주어졌을_때() {
        Race race = new Race("sisu,java,pobi", "3");
        assertThat(race.getRacingCars().stream().map(Car::getName).toList()).containsExactly("sisu", "java", "pobi");
    ...
    void 정수가_아닌_값이_round_인자로_주어졌을_때() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> {
                    Race race = new Race("sisu", "0.999999999999999999999999999999999999999999");
                });
        assertThrows(IllegalArgumentException.class,
                () -> {
