...
class ValidatorTest2 {
    ...
    void testIsEmptyName_ShouldThrowException_WhenUserNameIsEmpty() {
    ...
    void testIsExceedMaxNameSize_ShouldThrowException_WhenUserNameExceedsMaxLength() {
        assertThatThrownBy(() -> validator.userNameValidate("use"))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    @DisplayName("입력 문자열이 빈 문자열일 때 예외 발생")
    void testIsEmptyInput_ShouldThrowException_WhenInputStringIsEmpty() {
    ...
    void testIsCommaInFrontOrBack_ShouldThrowException_WhenCommaAtStartOrEnd() {
        validator = new Validator(",user1,user2,user3,");
        assertThatThrownBy(validator::userInputValidate)
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testIsExceedMaxInputSize_ShouldThrowException_WhenInputStringExceedsMaxLength() {
    ...
    void testIsValidateNumber_ShouldThrowException_WhenTryNumberOutOfRange() {
    ...
    void testUserInputValidate_ShouldNotThrowException_WhenInputIsValid() {
        validator = new Validator("user1,user2,user3");
    ...
    void testUserNameValidate_ShouldNotThrowException_WhenUserNameIsValid() {
