...
public class InputValidatorTest {
    ...
    void validateCarNames_InputtedWrongCarNames_ExceptionThrown(String carNames) {
        ...
        final InputValidator inputValidator = new InputValidator(carNamesValidator, carNameValidator, numberValidator);
    ...
    @ParameterizedTest
    @ValueSource(strings = {"", " ", "0", "-1", "-2", "-3", "-10", "-100"})
    @DisplayName("잘못된 횟수 입력 예외 발생")
    void validateNumber_InputtedWrongNumber_ExceptionThrown(String number) {
        //given
        final CarNamesValidator carNamesValidator = new CarNamesValidator();
        final CarNameValidator carNameValidator = new CarNameValidator();
        final NumberValidator numberValidator = new NumberValidator();
