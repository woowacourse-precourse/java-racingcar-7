...
class CarNameValidatorTest {
    ...
    void shouldThrowExceptionForDuplicateCarNames() {
        ...
        assertThrows(RacingGameException.DuplicatedCarNameException.class,
                () -> CarNameValidator.validateCarNameIsCorrect(carNames));
    }
    ...
    void shouldThrowExceptionForCarNameWithSpaces() {
        ...
        assertThrows(RacingGameException.BlankCarNameException.class,
                () -> CarNameValidator.validateCarNameIsCorrect(carNames));
    }
    ...
    void shouldThrowExceptionForEmptyCarNames() {
        ...
        assertThrows(RacingGameException.CarNameEmptyInputException.class,
                () -> CarNameValidator.validateCarNameIsCorrect(carNames));
    }
    ...
    void shouldThrowExceptionForCarNameExceedingLength() {
        ...
        assertThrows(RacingGameException.InvalidNameLengthException.class,
                () -> CarNameValidator.validateCarNameIsCorrect(carNames));
    }
}