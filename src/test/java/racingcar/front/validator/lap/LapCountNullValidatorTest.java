...
import racingcar.app.front.validator.lap.LapCountNullValidator;

public class LapCountNullValidatorTest {

    private final LapCountNullValidator validator = LapCountNullValidator.initiate();
